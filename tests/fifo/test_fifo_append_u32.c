    ...
    get_u8_l_func   get_u8_l)
{
    ...
    if (expected_result != append(
        ...
        get_u8_m_h(expected_data) != fifo.p_data[1U] ||
        get_u8_m_l(expected_data) != fifo.p_data[2U] ||
        get_u8_l(expected_data) != fifo.p_data[3U] ||
    ...
    if (expected_result != append(
                               ...
                               &actual_ec) ||
        expected_ec != actual_ec ||
        get_u8_h(expected_data) != fifo.p_data[6U] ||
        get_u8_m_h(expected_data) != fifo.p_data[7U] ||
        get_u8_m_l(expected_data) != fifo.p_data[8U] ||
