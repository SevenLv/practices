...
int main(void)
{
    ...
    if (expected_result != pra_fifo_append_u16_be(
                               &fifo,
                               data_to_append,
                               PRA_EC_T_NULL))
    {
    ...
    if (expected_result != pra_fifo_append_u16_be(
                               ...
                               &actual_ec) ||
        expected_ec != actual_ec ||
        ((uint8_t)((expected_data >> PRA_BITS_U8_WIDTH) & UINT8_MAX)) != fifo.p_data[0U] ||
        ((uint8_t)(expected_data & UINT8_MAX)) != fifo.p_data[1U] ||
    ...
    if (expected_result != pra_fifo_append_u16_be(
                               ...
                               &actual_ec) ||
        expected_ec != actual_ec ||
        ((uint8_t)((expected_data >> PRA_BITS_U8_WIDTH) & UINT8_MAX)) != fifo.p_data[8U] ||
        ((uint8_t)(expected_data & UINT8_MAX)) != fifo.p_data[9U] ||
        expected_used_length != fifo.used_length ||
        0U != fifo.next_w_pos)
    {
        result != err_error8;
